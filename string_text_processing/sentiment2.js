...
function sentiment(text) {
  let positiveMatch = text.match(positiveRegex);
  let negativeMatch = text.match(negativeRegex);
  let positiveCount = positiveMatch.length;
  let negativeCount = negativeMatch.length;
  ...
  console.log('Positive sentiments: ' + positiveMatch.join(', ').toLowerCase());
  console.log('');
  console.log(`There are ${negativeCount} negative words in the text.`);
  console.log('Positive sentiments: ' + negativeMatch.join(', ').toLowerCase());
  console.log('');
